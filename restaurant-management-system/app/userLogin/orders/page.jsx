...
async function OrderPage() {
    ...
    if (!session?.user?.id) {
        return (
            ...
            >
                <div
                    className="absolute top-2 right-2 z-50 text-xs text-gray-400"
                >
                    <Link
                        ...
                        >
                            ...
                            >
                                {orders.map((order) => (
                                    <div
                                        key={order.order_id}
                                        className="bg-red-400 p-4 rounded-lg shadow-md"
                                    >
                                        <div
                                            className="flex justify-between items-center"
                                        >
                                            <h2
                                                className={`text-xl text-black font-semibold ${playfair.className}`}
                                            >
