            ...
            <SidebarItems>
                <SidebarItemGroup>
                    <SidebarItem
                        ...
                        active={(pathname === '/adminLogin/dashboard')}
                    >
                        Dashboard
                    </SidebarItem>
                    <SidebarCollapse
                    ...
                    >
                        <div
                            className='max-h-[150px] overflow-y-auto pr-2 scrollbar-hide'
                        >
                            <SidebarItem
                                href='/adminLogin/menu#veg_starters'
                            >
                                Veg Starters
                            </SidebarItem>
                            <SidebarItem
                                href='/adminLogin/menu#non_veg_starters'
                            >
                                Non Veg Starters
                            </SidebarItem>
                            <SidebarItem
                                href='/adminLogin/menu#veg_platters'
                            >
                                Veg Platters
                            </SidebarItem>
                            <SidebarItem
                                href='/adminLogin/menu#non_veg_platters'
                            >
                                Non Veg Platters
                            </SidebarItem>
                            <SidebarItem
                                href='/adminLogin/menu#veg_main_course'
                            >
                                Veg Main Course
                            </SidebarItem>
                            <SidebarItem
                                href='/adminLogin/menu#non_veg_main_course'
                            >
                                Non Veg Main Course
                            </SidebarItem>
                            <SidebarItem
                                href='/adminLogin/menu#veg_biryani'
                            >
                                Veg Biryani
                            </SidebarItem>
                            <SidebarItem
                                href='/adminLogin/menu#non_veg_biryani'
                            >
                                Non Veg Biryani
                            </SidebarItem>
                            <SidebarItem
                                href='/adminLogin/menu#veg_rice'
                            >
                                Veg Rice
                            </SidebarItem>
                            <SidebarItem
                                href='/adminLogin/menu#non_veg_rice'
                            >
                                Non Veg Rice
                            </SidebarItem>
                            <SidebarItem
                                href='/adminLogin/menu#rotis_and_breads'
                            >
                                Rotis and Breads
                            </SidebarItem>
                            <SidebarItem
                                href='/adminLogin/menu#chaats'
                            >
                                Chaats
                            </SidebarItem>
                            <SidebarItem
                                href='/adminLogin/menu#salads'
                            >
                                Salads
                            </SidebarItem>
                            <SidebarItem
                                href='/adminLogin/menu#raitas'
                            >
                                Raitas
                            </SidebarItem>
                            <SidebarItem
                                href='/adminLogin/menu#sweet_dishes'
                            >
                                Sweet Dishes
                            </SidebarItem>
                            <SidebarItem
                                href='/adminLogin/menu#beverages'
                            >
                                Beverages
                            </SidebarItem>
                        </div>
                    ...
                    <SidebarItem
                        href='/adminLogin/orders'
                        icon={IoFastFoodOutline}
                        active={(pathname === '/adminLogin/orders')}
                    >
                        Orders
                    </SidebarItem>
                </SidebarItemGroup>
