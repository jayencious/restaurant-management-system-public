...
export function NavBar() {
    return (
        <Navbar fluid rounded>
            <NavbarBrand href="/">
               <Image src='/taste_of_the_world_logo.jpg' className="mr-3 h-6 sm:h-9" alt="Taste of the World Logo" width={45} height={350} />
                ...
                <Dropdown
                    ...
                    label={
                        ...
                        <DropdownHeader>
                            ...
                            <span className="block truncate text-sm font-medium">johndoe123@gmail.com</span>
                        </DropdownHeader>
